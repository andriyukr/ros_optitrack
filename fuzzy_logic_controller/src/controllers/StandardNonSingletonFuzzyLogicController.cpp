...
namespace fl {
    ...
    StandardNonSingletonFuzzyLogicController::StandardNonSingletonFuzzyLogicController(const std::string& name) : FuzzyLogicController(name){
        ...
        engine->configure("Minimum", "", "Minimum", "Maximum", "WeightedSum");
