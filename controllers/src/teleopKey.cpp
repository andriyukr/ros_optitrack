...
public:
    Teleop(){
        ...
        command_publisher = node_handle.advertise<std_msgs::Int8>("/bebop/command", 1);
        velocity_publisher = node_handle.advertise<geometry_msgs::Quaternion>("/bebop/command_velocity_keyboard", 1);
        camera_publisher = node_handle.advertise<geometry_msgs::Vector3>("/bebop/command_camera", 1);
    }
